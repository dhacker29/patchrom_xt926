...
.field protected static PROPERTY_CDMA_HOME_OPERATOR_NUMERIC:Ljava/lang/String;
...
# instance fields
.field mApnListTracker:Lcom/motorola/android/internal/telephony/ApnListTracker;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;)V
    ...
    .line 176
    iput-boolean v1, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mIsWifiEnabledBeforeEcm:Z
...
.method private handleEnterEmergencyCallbackMode(Landroid/os/Message;)V
    ...
    .line 987
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->turnOffWifiForEmergencyCall()V
...
.method private updateVoiceMail()V
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getStoredVoicemailPriority()I

    move-result v1

    invoke-virtual {p0, v0, v1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setVoiceMessageCount(II)V
...
.method public dispose()V
    ...
    .line 291
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mApnListTracker:Lcom/motorola/android/internal/telephony/ApnListTracker;

    invoke-virtual {v0}, Lcom/motorola/android/internal/telephony/ApnListTracker;->dispose()V
...
.method public getImsi_m()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/IccRecords;->getIMSI_M()Ljava/lang/String;
...
.method protected getStoredVoicemailPriority()I
    .locals 3
    ...
    .line 844
    .local v0, sp:Landroid/content/SharedPreferences;
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mVmPriorityKey:Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "CDMAPhone: init set \'gsm.sim.operator.numeric\' to operator=\'"
    ...
    invoke-static {v1, v5, v6}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/cdma/CDMAPhone;->handleNetworkScanCompleted(Landroid/os/AsyncResult;)V
...
.method protected init(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;)V
    ...
    invoke-interface {v4, v9}, Lcom/android/internal/telephony/CommandsInterface;->setPhoneType(I)V
    ...
    invoke-direct {v4, p0, p1, v8}, Lcom/android/internal/telephony/cdma/EriManager;-><init>(Lcom/android/internal/telephony/PhoneBase;Landroid/content/Context;I)V
    ...
    invoke-interface {v4, p0, v10, v6}, Lcom/android/internal/telephony/CommandsInterface;->registerForExitEmergencyCallbackMode(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    sput-object v4, Lcom/android/internal/telephony/cdma/CDMAPhone;->mCarrierOtaSpNumSchema:Ljava/lang/String;

    .line 241
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->updateVoiceMail()V

    .line 244
    new-instance v4, Lcom/motorola/android/internal/telephony/ApnListTracker;

    invoke-direct {v4, p0}, Lcom/motorola/android/internal/telephony/ApnListTracker;-><init>(Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v4, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mApnListTracker:Lcom/motorola/android/internal/telephony/ApnListTracker;
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mTurnOffWifiOnECM:Z
...
.method protected onUpdateIccAvailability()V
    ...
    .line 1262
    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mRuimCard:Lcom/android/internal/telephony/uicc/UiccCard;
...
.method turnOffWifiForEmergencyCall()V
    .locals 4

    .prologue
    .line 1035
    iget-boolean v1, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mTurnOffWifiOnECM:Z
    ...
    .line 1040
    iget-boolean v1, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mIsWifiEnabledBeforeEcm:Z
    ...
    const-string v2, "Disable WiFi on enter ECM"
