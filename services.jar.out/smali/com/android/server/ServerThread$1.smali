...
.field final synthetic val$sensorHubF:Lcom/motorola/server/SensorHubService;
...
# direct methods
.method constructor <init>(Lcom/android/server/ServerThread;ZLandroid/content/Context;Lcom/android/server/BatteryService;Lcom/android/server/NetworkManagementService;Lcom/android/server/net/NetworkStatsService;Lcom/android/server/net/NetworkPolicyManagerService;Lcom/android/server/ConnectivityService;Lcom/android/server/DockObserver;Lcom/android/server/usb/UsbService;Lcom/motorola/server/MotDockObserver;Lcom/android/server/UiModeManagerService;Lcom/android/server/RecognitionManagerService;Lcom/android/server/AppWidgetService;ZLcom/android/server/WallpaperManagerService;Lcom/android/server/InputMethodManagerService;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LocationManagerService;Lcom/motorola/server/SensorHubService;Lcom/android/server/CountryDetectorService;Lcom/android/server/ThrottleService;Lcom/android/server/NetworkTimeUpdateService;Lcom/android/server/CommonTimeManagementService;Lcom/android/server/TextServicesManagerService;Landroid/service/dreams/DreamManagerService;Lcom/android/server/input/InputManagerService;Landroid/server/BluetoothService;)V
    .locals 1
    .parameter
    .parameter
    .parameter
    ...
    iput-object p11, p0, Lcom/android/server/ServerThread$1;->val$motDockF:Lcom/motorola/server/MotDockObserver;
    ...
    iput-object v0, p0, Lcom/android/server/ServerThread$1;->val$sensorHubF:Lcom/motorola/server/SensorHubService;
...
.method public run()V
    ...
    :goto_6
    :try_start_7
    iget-object v1, p0, Lcom/android/server/ServerThread$1;->val$motDockF:Lcom/motorola/server/MotDockObserver;

    if-eqz v1, :cond_8

    iget-object v1, p0, Lcom/android/server/ServerThread$1;->val$motDockF:Lcom/motorola/server/MotDockObserver;

    invoke-virtual {v1}, Lcom/motorola/server/MotDockObserver;->systemReady()V
    :try_end_7
    ...
    :goto_d
    :try_start_e
    iget-object v1, p0, Lcom/android/server/ServerThread$1;->val$sensorHubF:Lcom/motorola/server/SensorHubService;

    if-eqz v1, :cond_f

    iget-object v1, p0, Lcom/android/server/ServerThread$1;->val$sensorHubF:Lcom/motorola/server/SensorHubService;

    invoke-virtual {v1}, Lcom/motorola/server/SensorHubService;->systemReady()V
    :try_end_e
    ...
    :goto_15
    :try_start_16
    invoke-static {}, Lcom/android/server/pm/ShutdownThread;->systemReady()V
    :try_end_16
    ...
    const-string v2, "making Moto Dock Service ready"
    ...
    const-string v2, "making SensorHub Service ready"
    ...
    const-string v2, "making ShutdownThread ready"
