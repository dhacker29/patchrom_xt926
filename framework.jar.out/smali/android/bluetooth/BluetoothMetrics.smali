.class public final Landroid/bluetooth/BluetoothMetrics;
...
.method static synthetic access$000()J
    ...
    .prologue
    .line 27
    invoke-static {}, Landroid/bluetooth/BluetoothMetrics;->now()J
...
.method private static buildAndSendCheckinEvent(Ljava/lang/String;Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;)V
    ...
    .prologue
    .line 156
    sget-object v1, Landroid/bluetooth/BluetoothMetrics;->mContext:Landroid/content/Context;
    ...
    new-instance v1, Landroid/bluetooth/BluetoothMetrics$1;

    invoke-direct {v1, p0, p1, p2, v0}, Landroid/bluetooth/BluetoothMetrics$1;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;Landroid/content/ContentResolver;)V

    invoke-virtual {v1}, Landroid/bluetooth/BluetoothMetrics$1;->start()V
...
.method public static logPairing(Landroid/content/Context;Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .line 74
    invoke-static {p0}, Landroid/bluetooth/BluetoothMetrics;->setContext(Landroid/content/Context;)V

    .line 75
    invoke-static {p1, p2, p3}, Landroid/bluetooth/BluetoothMetrics;->logPairingStateChange(Landroid/bluetooth/BluetoothDevice;II)V
...
.method private static logPairingStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    invoke-static {v0, v1, p0}, Landroid/bluetooth/BluetoothMetrics;->buildAndSendCheckinEvent(Ljava/lang/String;Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;)V
...
.method public static logProfile(Landroid/content/Context;Landroid/bluetooth/BluetoothDevice;III)V
    ...
    invoke-static/range {v0 .. v6}, Landroid/bluetooth/BluetoothMetrics;->logProfileStateChange(Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;IIIII)V
...
.method private static logProfileStateChange(Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;IIIII)V
    .locals 2
    .parameter "tag_prefix"
    .parameter "device"
    .parameter "prevState"
    .parameter "state"
    .parameter "connected_state"
    .parameter "connecting_state"
    .parameter "disconnected_state"
    ...
    invoke-static {v0, v1, p1}, Landroid/bluetooth/BluetoothMetrics;->buildAndSendCheckinEvent(Ljava/lang/String;Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;)V
...
.method private static setContext(Landroid/content/Context;)V
    ...
    .prologue
    .line 121
    sput-object p0, Landroid/bluetooth/BluetoothMetrics;->mContext:Landroid/content/Context;
