...
.method constructor <init>()V
    ...
    .line 169
    const-string/jumbo v0, "sys.mot.ui.launched"

    invoke-static {v0, v2}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Landroid/app/ActivityThread;->mUILaunched:Z
...
.method static synthetic access$3000(Landroid/app/ActivityThread;Landroid/app/LoadedApk;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 139
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->handleMakeApplication(Landroid/app/LoadedApk;)V
...
.method private collectProviderCallbacks(Ljava/util/ArrayList;)V
    .locals 4
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 3704
    .local p1, callbacks:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ComponentCallbacks2;>;"
    ...
    .line 3705
    :try_start_0
    iget-object v2, p0, Landroid/app/ActivityThread;->mLocalProviders:Ljava/util/HashMap;
    ...
    .line 3707
    .local v1, providerClientRecord:Landroid/app/ActivityThread$ProviderClientRecord;
    ...
    .end local v1           #providerClientRecord:Landroid/app/ActivityThread$ProviderClientRecord;
    :catchall_0
    move-exception v2
...
.method private freeTextLayoutCachesInUIThreadAndWait()V
    .locals 5
    ...
    .line 3910
    .local v1, future:Ljava/util/concurrent/FutureTask;,"Ljava/util/concurrent/FutureTask<Ljava/lang/Boolean;>;"
    ...
    const-string v4, "Exception in running task in UI Thread"
...
.method private handleLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)V
    ...
    const-string v5, "ActivityThread.handleLaunchActivity start: "
...
.method private final handleMakeApplication(Landroid/app/LoadedApk;)V
    .locals 5
    .parameter "apk"
    ...
    invoke-virtual {p1, v2, v3}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
...
.method private final incProviderRefLocked(Landroid/app/ActivityThread$ProviderRefCount;Z)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v1, v0}, Landroid/app/ActivityThread;->refContentProviderLocked(Landroid/app/ActivityThread$ProviderRefCount;II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    :try_start_1
    invoke-direct {p0, p1, v1, v2}, Landroid/app/ActivityThread;->refContentProviderLocked(Landroid/app/ActivityThread$ProviderRefCount;II)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method private installProvider(Landroid/content/Context;Landroid/app/IActivityManager$ContentProviderHolder;Landroid/content/pm/ProviderInfo;ZZZ)Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    const-string v19, "Loading provider "
    ...
    const-string v19, "Unable to get context for package "
    ...
    const-string v19, " while loading content provider "
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/app/Application;->getPackageName()Ljava/lang/String;
    ...
    invoke-direct {v0, v4}, Landroid/app/ActivityThread;->scheduleMakeApplication(Landroid/content/pm/ApplicationInfo;)V
    :try_end_0
    ...
    .line 4825
    invoke-virtual {v12}, Landroid/content/ContentProvider;->getIContentProvider()Landroid/content/IContentProvider;
    ...
    const-string v19, "Failed to instantiate class "
    ...
    const-string v19, " from sourceDir "
    ...
    invoke-virtual {v12, v5, v0}, Landroid/content/ContentProvider;->attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    .line 4855
    :try_start_2
    invoke-interface {v15}, Landroid/content/IContentProvider;->asBinder()Landroid/os/IBinder;

    move-result-object v11

    .line 4856
    .local v11, jBinder:Landroid/os/IBinder;
    if-eqz v12, :cond_9
    ...
    iget-object v0, v0, Landroid/app/ActivityThread;->mLocalProvidersByName:Ljava/util/HashMap;
    ...
    check-cast v13, Landroid/app/ActivityThread$ProviderClientRecord;

    .line 4859
    .local v13, pr:Landroid/app/ActivityThread$ProviderClientRecord;
    if-eqz v13, :cond_8

    .line 4864
    iget-object v15, v13, Landroid/app/ActivityThread$ProviderClientRecord;->mProvider:Landroid/content/IContentProvider;

    .line 4873
    :goto_3
    iget-object v0, v13, Landroid/app/ActivityThread$ProviderClientRecord;->mHolder:Landroid/app/IActivityManager$ContentProviderHolder;

    move-object/from16 v16, v0

    .line 4908
    .end local v8           #cname:Landroid/content/ComponentName;
    .end local v13           #pr:Landroid/app/ActivityThread$ProviderClientRecord;
    .local v16, retHolder:Landroid/app/IActivityManager$ContentProviderHolder;
    :goto_4
    monitor-exit v18

    goto/16 :goto_1

    .end local v11           #jBinder:Landroid/os/IBinder;
    .end local v16           #retHolder:Landroid/app/IActivityManager$ContentProviderHolder;
    :catchall_0
    move-exception v17
    ...
    invoke-virtual {v0, v1, v9}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v19, "Unable to get provider "
    ...
    .line 4866
    .restart local v8       #cname:Landroid/content/ComponentName;
    .restart local v11       #jBinder:Landroid/os/IBinder;
    .restart local v13       #pr:Landroid/app/ActivityThread$ProviderClientRecord;
    :cond_8
    :try_start_3
    new-instance v10, Landroid/app/IActivityManager$ContentProviderHolder;

    move-object/from16 v0, p3

    invoke-direct {v10, v0}, Landroid/app/IActivityManager$ContentProviderHolder;-><init>(Landroid/content/pm/ProviderInfo;)V
    :try_end_3
    ...
    :try_start_4
    iput-object v15, v10, Landroid/app/IActivityManager$ContentProviderHolder;->provider:Landroid/content/IContentProvider;
    ...
    iput-boolean v0, v10, Landroid/app/IActivityManager$ContentProviderHolder;->noReleaseNeeded:Z

    .line 4869
    move-object/from16 v0, p0

    invoke-direct {v0, v15, v12, v10}, Landroid/app/ActivityThread;->installProviderAuthoritiesLocked(Landroid/content/IContentProvider;Landroid/content/ContentProvider;Landroid/app/IActivityManager$ContentProviderHolder;)Landroid/app/ActivityThread$ProviderClientRecord;
    ...
    iget-object v0, v0, Landroid/app/ActivityThread;->mProviderRefCountMap:Ljava/util/HashMap;
    ...
    check-cast v14, Landroid/app/ActivityThread$ProviderRefCount;

    .line 4876
    .local v14, prc:Landroid/app/ActivityThread$ProviderRefCount;
    if-eqz v14, :cond_b
    ...
    invoke-direct {v0, v14, v1}, Landroid/app/ActivityThread;->incProviderRefLocked(Landroid/app/ActivityThread$ProviderRefCount;Z)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
    ...
    invoke-direct {v0, v14, v1, v2, v3}, Landroid/app/ActivityThread;->removeContentProvider(Landroid/app/ActivityThread$ProviderRefCount;Landroid/app/IActivityManager$ContentProviderHolder;ZZ)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_0
    ...
    :goto_6
    :try_start_7
    iget-object v0, v14, Landroid/app/ActivityThread$ProviderRefCount;->holder:Landroid/app/IActivityManager$ContentProviderHolder;

    move-object/from16 v16, v0

    .restart local v16       #retHolder:Landroid/app/IActivityManager$ContentProviderHolder;
    goto/16 :goto_4
    ...
    invoke-direct {v0, v15, v12, v1}, Landroid/app/ActivityThread;->installProviderAuthoritiesLocked(Landroid/content/IContentProvider;Landroid/content/ContentProvider;Landroid/app/IActivityManager$ContentProviderHolder;)Landroid/app/ActivityThread$ProviderClientRecord;

    move-result-object v7

    .line 4897
    .local v7, client:Landroid/app/ActivityThread$ProviderClientRecord;
    if-eqz p5, :cond_c

    .line 4898
    new-instance v14, Landroid/app/ActivityThread$ProviderRefCount;

    .end local v14           #prc:Landroid/app/ActivityThread$ProviderRefCount;
    const/16 v17, 0x3e8
    ...
    invoke-direct {v14, v0, v7, v1, v2}, Landroid/app/ActivityThread$ProviderRefCount;-><init>(Landroid/app/IActivityManager$ContentProviderHolder;Landroid/app/ActivityThread$ProviderClientRecord;II)V

    .line 4904
    .restart local v14       #prc:Landroid/app/ActivityThread$ProviderRefCount;
    :goto_7
    move-object/from16 v0, p0
    ...
    .line 4890
    .end local v7           #client:Landroid/app/ActivityThread$ProviderClientRecord;
    .restart local v14       #prc:Landroid/app/ActivityThread$ProviderRefCount;
    :catch_2
    move-exception v17
...
.method private final refContentProviderLocked(Landroid/app/ActivityThread$ProviderRefCount;II)V
    .locals 5
    .parameter "prc"
    .parameter "stable"
    .parameter "unstable"
    ...
    invoke-interface {v2, v3, p2, p3}, Landroid/app/IActivityManager;->refContentProvider(Landroid/os/IBinder;II)Z
    :try_end_0
    ...
    const-string/jumbo v3, "refContentProvider("
    ...
    .line 4448
    iput-object v1, p1, Landroid/app/ActivityThread$ProviderRefCount;->lastStack:Ljava/lang/Throwable;
    ...
    const-string v3, "Last call stack to the operation on ref count"

    iget-object v4, p1, Landroid/app/ActivityThread$ProviderRefCount;->lastStack:Ljava/lang/Throwable;
...
.method private final removeContentProvider(Landroid/app/ActivityThread$ProviderRefCount;Landroid/app/IActivityManager$ContentProviderHolder;ZZ)V
    .locals 6
    .parameter "prc"
    .parameter "holder"
    .parameter "p"
    ...
    iget-object v1, p1, Landroid/app/ActivityThread$ProviderRefCount;->holder:Landroid/app/IActivityManager$ContentProviderHolder;

    .line 4457
    .local v1, h:Landroid/app/IActivityManager$ContentProviderHolder;
    :goto_0
    :try_start_0
    invoke-static {}, Landroid/app/ActivityManagerNative;->getDefault()Landroid/app/IActivityManager;
    ...
    iget-object v4, v1, Landroid/app/IActivityManager$ContentProviderHolder;->connection:Landroid/os/IBinder;

    invoke-interface {v3, v4, p4}, Landroid/app/IActivityManager;->removeContentProvider(Landroid/os/IBinder;Z)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    :goto_1
    sget-boolean v3, Landroid/app/ActivityThread;->IS_USER_BUILD:Z
    ...
    const-string/jumbo v5, "removeContentProvider("
    ...
    iget-object v5, v1, Landroid/app/IActivityManager$ContentProviderHolder;->connection:Landroid/os/IBinder;
    ...
    .line 4472
    iput-object v2, p1, Landroid/app/ActivityThread$ProviderRefCount;->lastStack:Ljava/lang/Throwable;
    ...
    .end local v1           #h:Landroid/app/IActivityManager$ContentProviderHolder;
    :cond_2
    move-object v1, p2
    ...
    .line 4459
    .restart local v1       #h:Landroid/app/IActivityManager$ContentProviderHolder;
    :catch_0
    move-exception v0
    ...
    const-string v4, "Last call stack to remove content provider"

    iget-object v5, p1, Landroid/app/ActivityThread$ProviderRefCount;->lastStack:Ljava/lang/Throwable;
...
.method private final scheduleMakeApplication(Landroid/content/pm/ApplicationInfo;)V
    .locals 2
    .parameter "ai"
    ...
    invoke-virtual {p0, p1, v1}, Landroid/app/ActivityThread;->getPackageInfoNoCheck(Landroid/content/pm/ApplicationInfo;Landroid/content/res/CompatibilityInfo;)Landroid/app/LoadedApk;
...
.method final completeRemoveProvider(Landroid/app/ActivityThread$ProviderRefCount;)V
    ...
    :try_start_2
    invoke-direct {p0, p1, v5, v6, v7}, Landroid/app/ActivityThread;->removeContentProvider(Landroid/app/ActivityThread$ProviderRefCount;Landroid/app/IActivityManager$ContentProviderHolder;ZZ)V
    :try_end_2
...
.method final freeTextLayoutCachesIfNeeded(I)V
    ...
    .line 3885
    invoke-direct {p0}, Landroid/app/ActivityThread;->isUIThread()Z
    ...
    :cond_2
    invoke-direct {p0}, Landroid/app/ActivityThread;->freeTextLayoutCachesInUIThreadAndWait()V
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 3864
    invoke-direct {p0, v1}, Landroid/app/ActivityThread;->collectProviderCallbacks(Ljava/util/ArrayList;)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZ)V
    ...
    .line 2672
    :cond_0
    iget-boolean v7, p0, Landroid/app/ActivityThread;->mUILaunched:Z

    if-nez v7, :cond_1

    .line 2673
    const-string/jumbo v7, "sys.mot.ui.launched"
    ...
    iput-boolean v7, p0, Landroid/app/ActivityThread;->mUILaunched:Z
...
.method final performPauseActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZ)Landroid/os/Bundle;
    ...
    .line 2929
    sget-boolean v6, Landroid/app/ActivityThread;->DEBUG_KPI:Z

    if-eqz v6, :cond_5

    .line 2930
    const-string v6, "KPI-6"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "ActivityThread.performPauseActivity callActivityOnPause start: "
    ...
    .line 2938
    const-string v6, "KPI-7"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "ActivityThread.performPauseActivity callActivityOnPause complete: "
...
.method public final releaseProvider(Landroid/content/IContentProvider;Z)Z
    ...
    :cond_3
    :try_start_2
    invoke-direct {p0, v3, v7, v5}, Landroid/app/ActivityThread;->refContentProviderLocked(Landroid/app/ActivityThread$ProviderRefCount;II)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :try_start_4
    invoke-direct {p0, v3, v5, v7}, Landroid/app/ActivityThread;->refContentProviderLocked(Landroid/app/ActivityThread$ProviderRefCount;II)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
