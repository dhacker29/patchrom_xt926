...
.method private getWindowFrame(Landroid/graphics/Rect;)V
    .locals 4
    .parameter "outRect"
    ...
    invoke-interface {v2, v3, p1}, Landroid/view/IWindowSession;->getWindowFrame(Landroid/view/IWindow;Landroid/graphics/Rect;)V
    :try_end_0
...
.method public dispatchIMEMotionEvent(Ljava/lang/String;Landroid/os/Bundle;)Z
    .locals 13
    .parameter "action"
    .parameter "data"
    ...
    .line 7518
    :cond_1
    const-string v11, "android.ime.command.MOTION_CLICK"
    ...
    const-string v11, "android.ime.command.MOTION_EVENT"
    ...
    .line 7526
    .local v8, winFrame:Landroid/graphics/Rect;
    invoke-direct {v5, v8}, Landroid/view/View;->getWindowFrame(Landroid/graphics/Rect;)V
    ...
    .line 7535
    .local v6, translator:Landroid/content/res/CompatibilityInfo$Translator;
    if-eqz v6, :cond_6

    .line 7536
    invoke-virtual {v6, v8}, Landroid/content/res/CompatibilityInfo$Translator;->translateRectInAppWindowToScreen(Landroid/graphics/Rect;)V
    ...
    .line 7546
    invoke-virtual {v7, v1}, Landroid/view/ViewRootImpl;->enqueueInputEvent(Landroid/view/InputEvent;)V
    ...
    .line 7548
    invoke-virtual {v7, v3}, Landroid/view/ViewRootImpl;->enqueueInputEvent(Landroid/view/InputEvent;)V
    ...
    .end local v6           #translator:Landroid/content/res/CompatibilityInfo$Translator;
    .end local v7           #viewRoot:Landroid/view/ViewRootImpl;
    .end local v8           #winFrame:Landroid/graphics/Rect;
    .end local v9           #x:F
    .end local v10           #y:F
    :cond_8
    const/4 v11, 0x0
