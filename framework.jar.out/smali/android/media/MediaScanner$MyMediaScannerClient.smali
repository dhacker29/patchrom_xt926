...
.method private endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZ)Landroid/net/Uri;
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$500(Landroid/media/MediaScanner;)I
    ...
    .line 895
    const-string v31, "is_notification"
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1100(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1200(Landroid/media/MediaScanner;)Landroid/media/MediaInserter;
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1300(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    .line 970
    const-string v31, "media_scanner_new_object_id"
    ...
    #getter for: Landroid/media/MediaScanner;->mMtpObjectHandle:I
    invoke-static/range {v32 .. v32}, Landroid/media/MediaScanner;->access$500(Landroid/media/MediaScanner;)I
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1600(Landroid/media/MediaScanner;)Z
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1700(Landroid/media/MediaScanner;)Z
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1800(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$2300(Landroid/media/MediaScanner;)Landroid/content/IContentProvider;
    ...
    invoke-static/range {v31 .. v32}, Landroid/media/MediaScanner;->access$1702(Landroid/media/MediaScanner;Z)Z
    ...
    cmp-long v31, v26, v31

    if-eqz v31, :cond_1b

    .line 915
    const-string v31, "datetaken"
    ...
    invoke-static/range {v31 .. v32}, Ljava/lang/Math;->abs(J)J
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1400(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1500(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$1900(Landroid/media/MediaScanner;)Z
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$2000(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$2100(Landroid/media/MediaScanner;)Z
    ...
    invoke-static/range {v31 .. v31}, Landroid/media/MediaScanner;->access$2200(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    .line 1048
    const-string/jumbo v31, "ringtone"
    ...
    invoke-static/range {v31 .. v32}, Landroid/media/MediaScanner;->access$1902(Landroid/media/MediaScanner;Z)Z
    ...
    invoke-static/range {v31 .. v32}, Landroid/media/MediaScanner;->access$2102(Landroid/media/MediaScanner;Z)Z
...
.method private setSettingIfNotSet(Ljava/lang/String;Landroid/net/Uri;J)V
    ...
    #getter for: Landroid/media/MediaScanner;->mContext:Landroid/content/Context;
    invoke-static {v0}, Landroid/media/MediaScanner;->access$2400(Landroid/media/MediaScanner;)Landroid/content/Context;
...
.method private toValues()Landroid/content/ContentValues;
    ...
    .line 819
    .local v2, tempGenre:Ljava/lang/String;
...
.method public doScanFile(Ljava/lang/String;Ljava/lang/String;JJZZZ)Landroid/net/Uri;
    ...
    #getter for: Landroid/media/MediaScanner;->LOCAL_LOGV:Z
    ...
    const-string/jumbo v8, "process file: "
    ...
    .line 570
    :cond_8
    iget-boolean v0, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mIsDrm:Z
    ...
    const-string v7, "Set as notifications,ringtones,alarms,music for downloaded DRM audio file"
...
.method public handleStringTag(Ljava/lang/String;Ljava/lang/String;)V
    ...
    #getter for: Landroid/media/MediaScanner;->LOCAL_LOGV:Z
    invoke-static {v1}, Landroid/media/MediaScanner;->access$600(Landroid/media/MediaScanner;)Z
    ...
    const-string v3, "Met invalid value for tag "
