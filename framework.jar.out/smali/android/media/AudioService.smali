...
# static fields
.field public static final ACTION_EARPIECE_STATUS_CHANGED:Ljava/lang/String; = "com.motorola.internal.intent.action.EARPIECE_STATUS_CHANGED"
...
.field public static final MOT_EXTRA_EARPIECE_STATE:Ljava/lang/String; = "com.motorola.internal.intent.extra.EARPIECE_STATE"
...
.field private mEQ:Lcom/motorola/android/effects/MMIEqualizer;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Landroid/media/AudioService;->applyAudioSession0()V
...
.method static synthetic access$4302(Landroid/media/AudioService;Landroid/view/VolumePanel;)Landroid/view/VolumePanel;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4400(Landroid/media/AudioService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7900(Landroid/media/AudioService;Z)V
    ...
    .prologue
    invoke-direct {p0, p1}, Landroid/media/AudioService;->broadcastEarpieceStatus(Z)V
...
.method private applyAudioSession0()V
    .locals 4

    .prologue
    :try_start_0
    new-instance v1, Lcom/motorola/android/effects/MMIEqualizer;

    const/4 v2, 0x0

    const/4 v3, 0x0

    invoke-direct {v1, v2, v3}, Lcom/motorola/android/effects/MMIEqualizer;-><init>(II)V

    iput-object v1, p0, Landroid/media/AudioService;->mEQ:Lcom/motorola/android/effects/MMIEqualizer;

    iget-object v1, p0, Landroid/media/AudioService;->mEQ:Lcom/motorola/android/effects/MMIEqualizer;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcom/motorola/android/effects/MMIEqualizer;->usePreset(S)V

    iget-object v1, p0, Landroid/media/AudioService;->mEQ:Lcom/motorola/android/effects/MMIEqualizer;

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Lcom/motorola/android/effects/MMIEqualizer;->setEnabled(Z)I

    const-string v1, "AudioService"

    const-string v2, "set 0 to audio session 0, success!"
    ...
    const-string v2, "set 0 to audio session 0, failed!"
...
.method private broadcastEarpieceStatus(Z)V
    .locals 3
    .parameter "force"
    ...
    const-string v1, "com.motorola.internal.intent.action.EARPIECE_STATUS_CHANGED"
...
.method private sendDeviceConnectionIntent(IILjava/lang/String;)V
    ...
    const-string v1, "vzw.hardware.hdmi"
    ...
    const-string v0, "verizon.intent.action.HDMI_PLUG"

    invoke-direct {v10, v0}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v10, vzw_intent:Landroid/content/Intent;
    const-string v0, "state"
    ...
    invoke-static {v10, v0}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;)V

    const-string v0, "AudioService"

    const-string v1, "Send VZW HDMI status intent"

    invoke-static {v0, v1}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    goto/16 :goto_0

    .end local v10           #vzw_intent:Landroid/content/Intent;
...
.method public isEarpieceOn()I
    ...
    .local v0, earpieceOn:I
    const-string v1, "EARPIECEON"
...
.method public setBluetoothScoOn(Z)V
    ...
    invoke-direct {p0, v3}, Landroid/media/AudioService;->broadcastEarpieceStatus(Z)V
...
.method setInCallModeInt(ILandroid/os/IBinder;I)I
    ...
    invoke-direct {v0, v3}, Landroid/media/AudioService;->broadcastEarpieceStatus(Z)V
...
.method public setMode(ILandroid/os/IBinder;)V
    ...
    invoke-virtual {p0, p1, p2, v2}, Landroid/media/AudioService;->setModeInt(ILandroid/os/IBinder;I)I
    ...
    invoke-direct {p0, v1}, Landroid/media/AudioService;->disconnectBluetoothSco(I)V

    :cond_4
    invoke-direct {p0, v0}, Landroid/media/AudioService;->broadcastEarpieceStatus(Z)V
...
.method public setRingerMode(I)V
    ...
    :cond_1
    const-string v0, "persist.sys.bootupvolume"
