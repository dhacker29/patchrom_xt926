...
.field private static final DEMO_MODE_KEY_SEQUENCE:[I = null
...
.field private static final KEY_PRESS_TIMEOUT:J = 0xbb8L
...
.field private mKeySequencePressed:I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEMO_MODE_KEY_SEQUENCE:[I
...
.method public constructor <init>()V
    ...
    iput-boolean v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mNavigationBarOnBottom:Z
    ...
    iput-boolean v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mScreenSaverMayRun:Z
    ...
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeySequencePressed:I

    iput-wide v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFirstPressTime:J
...
.method static synthetic access$600(Lcom/android/internal/policy/impl/PhoneWindowManager;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$802(Lcom/android/internal/policy/impl/PhoneWindowManager;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private handleLongPressOnHome()V
    ...
    :cond_2
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCooldownMode:Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;Landroid/os/LocalPowerManager;)V
    ...
    iget-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIntentReceiver:Landroid/content/BroadcastReceiver;

    const-string v6, "android.permission.DEVICE_POWER"

    invoke-virtual {v4, v5, v0, v6, v9}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    invoke-static {v4}, Lcom/motorola/errorprevention/InsertionErrorPrevention;->getInstance(Landroid/content/res/Resources;)Lcom/motorola/errorprevention/InsertionErrorPrevention;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mErrorPrevention:Lcom/motorola/errorprevention/InsertionErrorPrevention;
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    const-string v34, "KPI-SCR-2"

    new-instance v35, Ljava/lang/StringBuilder;

    invoke-direct/range {v35 .. v35}, Ljava/lang/StringBuilder;-><init>()V

    const-string v36, "PhoneWindowManager.interceptKeyBeforeQueueing start:  keyCode="
    ...
    const-string v35, "interceptKeyTi: cooldown mode, ingore KEYCODE_CAMERA"
    ...
    iget-wide v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFirstPressTime:J
    ...
    iput v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeySequencePressed:I

    :cond_4
    move-object/from16 v0, p0

    iget v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeySequencePressed:I

    move/from16 v34, v0

    sget-object v35, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEMO_MODE_KEY_SEQUENCE:[I
    ...
    sget-object v34, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEMO_MODE_KEY_SEQUENCE:[I
    ...
    iput-wide v0, v2, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFirstPressTime:J
    ...
    const-string v35, "******************* send out intent to launch demo mode"

    invoke-static/range {v34 .. v35}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v18, Landroid/content/Intent;

    const-string v34, "com.motorola.intent.action.START_DEMO_MODE"
    ...
    .local v28, statusbar:Lcom/android/internal/statusbar/IStatusBarService;
    if-eqz v28, :cond_c

    invoke-interface/range {v28 .. v28}, Lcom/android/internal/statusbar/IStatusBarService;->cancelPreloadRecentApps()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .end local v28           #statusbar:Lcom/android/internal/statusbar/IStatusBarService;
    :cond_c
    :goto_3
    const/16 v34, 0x0
    ...
    const-string v35, "Ignoring HOME; in cooldown mode or there\'s a ringing incoming call."
    ...
    const-string v36, "double tap home key, packagename ="
    ...
    .restart local v28       #statusbar:Lcom/android/internal/statusbar/IStatusBarService;
    if-eqz v28, :cond_1d

    invoke-interface/range {v28 .. v28}, Lcom/android/internal/statusbar/IStatusBarService;->preloadRecentApps()V
    :try_end_2
    ...
    const-string v35, "RemoteException when preloading recent apps"
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    iget-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSystemBooted:Z
    ...
    const-string v26, "PhoneWindowManager.interceptKeyBeforeQueueing start:  keyCode="
    ...
    invoke-virtual {v0, v4, v1, v2}, Lcom/android/internal/policy/impl/PhoneWindowManager;->performHapticFeedbackLw(Landroid/view/WindowManagerPolicy$WindowState;IZ)Z
    ...
    iget-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadless:Z
    ...
    iget-object v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mErrorPrevention:Lcom/motorola/errorprevention/InsertionErrorPrevention;
    ...
    invoke-virtual {v4}, Lcom/motorola/errorprevention/InsertionErrorPrevention;->isPhysicalKeyboardInit()Z
    ...
    invoke-virtual {v4, v0, v1, v15, v7}, Lcom/motorola/errorprevention/InsertionErrorPrevention;->isFalseHardKey(JZI)Z
    ...
    const-string v4, "KPI-SCR-3"

    new-instance v25, Ljava/lang/StringBuilder;

    invoke-direct/range {v25 .. v25}, Ljava/lang/StringBuilder;-><init>()V

    const-string v26, "PhoneWindowManager.interceptKeyBeforeQueueing complete: result="
    ...
    iget v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDockMode:I
    ...
    invoke-virtual {v0, v7, v4}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->onWakeKeyWhenKeyguardShowingTq(IZ)Z
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyTriggered:Z
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpKeyTriggered:Z
    ...
    invoke-virtual {v0, v4, v7}, Lcom/android/internal/policy/impl/PhoneWindowManager;->handleVolumeKey(II)V
    :try_end_1
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyDown(Z)V
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyUp(Z)Z
    ...
    iget v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mEndcallBehavior:I
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerKeyTriggered:Z
    ...
    iget v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIncallPowerBehavior:I
    ...
    iget-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPendingPowerKeyUpCanceled:Z
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPendingPowerKeyUpCanceled:Z
    ...
    .local v22, pm:Landroid/os/IPowerManager;
    :try_start_6
    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
    ...
    invoke-interface {v0, v1, v2, v4, v3}, Landroid/os/IPowerManager;->userActivityWithForce(JZZ)V
    :try_end_6
    ...
    const-string v25, "Got remote exception"
    ...
    .end local v16           #ex:Landroid/os/RemoteException;
    .end local v22           #pm:Landroid/os/IPowerManager;
    :catch_4
    move-exception v16
    ...
    .end local v16           #ex:Landroid/os/RemoteException;
    .restart local v22       #pm:Landroid/os/IPowerManager;
    :catch_5
    move-exception v16
    ...
    const-string v25, "Got Null Pointer exception"
    ...
    .end local v16           #ex:Ljava/lang/NullPointerException;
    .end local v22           #pm:Landroid/os/IPowerManager;
    .end local v24           #telephonyService:Lcom/android/internal/telephony/ITelephony;
    :sswitch_3
    if-eqz v15, :cond_c
    ...
    invoke-virtual {v13, v0, v4}, Landroid/media/AudioManager;->setStreamMute(IZ)V
    ...
    invoke-virtual {v13, v4, v0, v1}, Landroid/media/AudioManager;->adjustSuggestedStreamVolume(III)V
    ...
    const-string v4, "android.mot.internal.intent.action.CALLING_MUTE"
    ...
    invoke-virtual {v13, v4}, Landroid/media/AudioManager;->setRingerMode(I)V
    ...
    .local v9, sendIntent:Z
    :goto_13
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadsetButtonDetector:Lcom/motorola/android/internal/policy/impl/HeadsetButtonDetector;
    ...
    invoke-virtual/range {v4 .. v12}, Lcom/motorola/android/internal/policy/impl/HeadsetButtonDetector;->passKey(JIZZIII)Z
...
.method public setInitialDisplaySize(Landroid/view/Display;II)V
    ...
    invoke-static {v9}, Lcom/motorola/android/internal/policy/impl/HeadsetButtonDetector;->getInstance(Landroid/content/Context;)Lcom/motorola/android/internal/policy/impl/HeadsetButtonDetector;

    move-result-object v9

    move-object/from16 v0, p0

    iput-object v9, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadsetButtonDetector:Lcom/motorola/android/internal/policy/impl/HeadsetButtonDetector;
...
.method public updateSettings()V
    ...
    invoke-static {v4, v12, v13}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-static {v4, v12, v13}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    .local v2, mMaximumScreenOffTimeout:I
    iget v10, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLockScreenTimeout:I
    ...
    :cond_4
    iput v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLockScreenTimeout:I
    ...
    invoke-static {v4, v10, v12}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    .end local v2           #mMaximumScreenOffTimeout:I
    ...
    .restart local v2       #mMaximumScreenOffTimeout:I
