...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/GsmAlphabet$ShiftType;,
        Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    }
.end annotation
...
.field public static final LOCK_SHIFT_16BIT:I = 0xff

.field public static final LOCK_SHIFT_NONE:I = 0x0

.field public static final LOCK_SHIFT_PORTUGUESE:I = 0x3

.field public static final LOCK_SHIFT_TURKISH:I = 0x1

.field public static final SINGLE_SHIFT_16BIT:I = 0xff

.field public static final SINGLE_SHIFT_NONE:I = 0x0

.field public static final SINGLE_SHIFT_PORTUGUESE:I = 0x3

.field public static final SINGLE_SHIFT_SPANISH:I = 0x2

.field public static final SINGLE_SHIFT_TURKISH:I = 0x1
...
.field public static final VALUE_ENCODING_METHOD_7BIT:I = 0x0

.field public static final VALUE_ENCODING_METHOD_LOCKING_SHIFT:I = 0x3

.field public static final VALUE_ENCODING_METHOD_SINGLE_SHIFT:I = 0x2

.field public static final VALUE_ENCODING_METHOD_UCS2:I = 0x1
...
.field private static final sISO3LangS:[Ljava/lang/String;

.field private static final sISO3LangToCode:Ljava/util/HashMap;
...
.method static constructor <clinit>()V
    ...
    const-string v14, "tur"

    aput-object v14, v12, v13

    const/4 v13, 0x1

    const-string v14, "spa"

    aput-object v14, v12, v13

    const/4 v13, 0x2

    const-string v14, "por"
    ...
    const-string v14, "guj"

    aput-object v14, v12, v13

    const/4 v13, 0x5

    const-string v14, "hin"

    aput-object v14, v12, v13

    const/4 v13, 0x6

    const-string v14, "kan"

    aput-object v14, v12, v13

    const/4 v13, 0x7

    const-string v14, "mal"
    ...
    const-string v14, "urd"

    aput-object v14, v12, v13

    sput-object v12, Lcom/android/internal/telephony/GsmAlphabet;->sISO3LangS:[Ljava/lang/String;
    ...
    sput-object v12, Lcom/android/internal/telephony/GsmAlphabet;->sISO3LangToCode:Ljava/util/HashMap;

    const/4 v3, 0x0

    .local v3, i:I
    :goto_0
    sget-object v12, Lcom/android/internal/telephony/GsmAlphabet;->sISO3LangS:[Ljava/lang/String;

    array-length v12, v12

    if-ge v3, v12, :cond_0

    sget-object v12, Lcom/android/internal/telephony/GsmAlphabet;->sISO3LangToCode:Ljava/util/HashMap;

    sget-object v13, Lcom/android/internal/telephony/GsmAlphabet;->sISO3LangS:[Ljava/lang/String;
    ...
    const-string v12, "telephony.sms.shift_table"
...
.method public static countGsmSeptets(Ljava/lang/CharSequence;Z)Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;
    ...
    invoke-static {p0, p1, v0, v1, v2}, Lcom/android/internal/telephony/GsmAlphabet;->countGsmSeptets(Ljava/lang/CharSequence;Z[I[II)Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;
...
.method public static countGsmSeptets(Ljava/lang/CharSequence;ZZZLjava/lang/String;)Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;
    .locals 5
    .parameter "s"
    .parameter "use7bitOnly"
    .parameter "enableNationalTable"
    ...
    invoke-static {p2, p3, p4}, Lcom/android/internal/telephony/GsmAlphabet;->toLangTableInfo(ZZLjava/lang/String;)Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;

    move-result-object v0

    .local v0, lti:Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    new-array v1, v3, [I

    iget v2, v0, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;->mLockShiftCode:I

    aput v2, v1, v4

    new-array v2, v3, [I

    iget v3, v0, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;->mSingleShiftCode:I

    aput v3, v2, v4

    iget v3, v0, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;->mSingleShiftCode:I

    invoke-static {p0, p1, v1, v2, v3}, Lcom/android/internal/telephony/GsmAlphabet;->countGsmSeptets(Ljava/lang/CharSequence;Z[I[II)Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;
...
.method public static countGsmSeptets(Ljava/lang/CharSequence;Z[I[II)Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;
    .locals 27
    .parameter "s"
    .parameter "use7bitOnly"
    .parameter "enabledLockingShiftTables"
    .parameter "enabledSingleShiftTables"
    .parameter "highestEnabledSingleShiftCode"
...
.method public static findGsmSeptetLimitIndex(Ljava/lang/String;IIZZLjava/lang/String;Z)I
    .locals 3
    .parameter "s"
    .parameter "start"
    .parameter "limit"
    ...
    .prologue
    invoke-static {p3, p4, p5}, Lcom/android/internal/telephony/GsmAlphabet;->toLangTableInfo(ZZLjava/lang/String;)Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;

    move-result-object v0

    .local v0, lti:Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    iget v1, v0, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;->mLockShiftCode:I

    iget v2, v0, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;->mSingleShiftCode:I

    invoke-static {p0, p1, p2, v1, v2}, Lcom/android/internal/telephony/GsmAlphabet;->findGsmSeptetLimitIndex(Ljava/lang/String;IIII)I
...
.method public static gsm7BitPackedToString([BIII)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/internal/telephony/GsmAlphabet;->gsm7BitPackedToString([BIIIBB)Ljava/lang/String;
...
.method public static gsm7BitPackedToString([BIIIBB)Ljava/lang/String;
    .locals 6
    .parameter "pdu"
    .parameter "offset"
    .parameter "lengthSeptets"
    ...
    const-string v2, "enter gsm7BitPackedToString..  offset == "
    ...
    const-string v2, " numPaddingBits == "
...
.method public static stringToGsm7BitPacked(Ljava/lang/String;IZ)[B
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/internal/telephony/GsmAlphabet;->stringToGsm7BitPacked(Ljava/lang/String;IZZZLjava/lang/String;Z)[B
...
.method public static stringToGsm7BitPacked(Ljava/lang/String;IZZZLjava/lang/String;Z)[B
    .locals 3
    .parameter "data"
    .parameter "startingSeptetOffset"
    .parameter "enableNationalTable"
    ...
    :cond_0
    invoke-static {p2, p3, p5}, Lcom/android/internal/telephony/GsmAlphabet;->toLangTableInfo(ZZLjava/lang/String;)Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    ...
    invoke-static {p0, p1, p6, v1, v2}, Lcom/android/internal/telephony/GsmAlphabet;->stringToGsm7BitPacked(Ljava/lang/String;IZII)[B
...
.method public static stringToGsm7BitPackedWithHeader(Ljava/lang/String;[BILjava/lang/String;)[B
    .locals 3
    .parameter "data"
    .parameter "header"
    ...
    .prologue
    invoke-static {p2, p3}, Lcom/android/internal/telephony/GsmAlphabet;->toLangTableInfo(ILjava/lang/String;)Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    ...
    invoke-static {p0, p1, v1, v2}, Lcom/android/internal/telephony/GsmAlphabet;->stringToGsm7BitPackedWithHeader(Ljava/lang/String;[BII)[B
...
.method public static toLangTableInfo(ILjava/lang/String;)Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    .locals 6
    .parameter "encodingMethod"
    .parameter "language"
    ...
    new-instance v2, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;

    invoke-direct {v2}, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;-><init>()V

    .local v2, lti:Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    const/4 v5, 0x2
    ...
    :cond_1
    invoke-static {v3, v0, p1}, Lcom/android/internal/telephony/GsmAlphabet;->toLangTableInfo(ZZLjava/lang/String;)Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;

    move-result-object v3

    return-object v3

    .end local v0           #isLockingShift:Z
    .end local v1           #isSingleShift:Z
    :cond_2
    move v1, v3

    goto :goto_0

    .restart local v1       #isSingleShift:Z
    :cond_3
    move v0, v3
...
.method public static toLangTableInfo(ZZLjava/lang/String;)Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    .locals 6
    .parameter "enableNationalTable"
    .parameter "ifSupportLockingShiftTable"
    .parameter "language"
    ...
    .local v2, lti:Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;
    sget-object v3, Lcom/android/internal/telephony/GsmAlphabet;->sISO3LangToCode:Ljava/util/HashMap;
    ...
    .local v0, integerLangCode:Ljava/lang/Integer;
    if-eqz p0, :cond_0
    ...
    const-string v5, "unknown ISO3 language=\""
    ...
    iput v1, v2, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;->mLockShiftCode:I

    iput v1, v2, Lcom/android/internal/telephony/GsmAlphabet$LangTableInfo;->mSingleShiftCode:I
