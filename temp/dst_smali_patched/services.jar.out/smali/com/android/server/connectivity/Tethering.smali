...
.field private mBootMode:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/IConnectivityManager;Landroid/os/Looper;)V
    ...
    iput-boolean v3, p0, Lcom/android/server/connectivity/Tethering;->usbTethered:Z
    ...
    iput v3, p0, Lcom/android/server/connectivity/Tethering;->mEnabledReverseNat:I
    ...
    const-string v4, "UsbIfaceHandler"

    invoke-direct {v1, v4}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v1, p0, Lcom/android/server/connectivity/Tethering;->mUsbIfaceThread:Landroid/os/HandlerThread;

    iget-object v1, p0, Lcom/android/server/connectivity/Tethering;->mUsbIfaceThread:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->start()V

    new-instance v1, Lcom/android/server/connectivity/Tethering$1;

    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mUsbIfaceThread:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v1, p0, v4}, Lcom/android/server/connectivity/Tethering$1;-><init>(Lcom/android/server/connectivity/Tethering;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/server/connectivity/Tethering;->mUsbIfaceHandler:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lcom/android/server/connectivity/Tethering;->mBootMode:Ljava/lang/String;
    ...
    const-string v4, "tether_reverse_nat_enabled"
    ...
    iput v1, p0, Lcom/android/server/connectivity/Tethering;->mEnabledReverseNat:I
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/server/connectivity/Tethering;->mDoEntitlementCheck:Z
...
.method private sendTetherStateChangedBroadcast()V
    ...
    iget-boolean v10, p0, Lcom/android/server/connectivity/Tethering;->usbTethered:Z

    if-eqz v10, :cond_a

    iget-boolean v10, p0, Lcom/android/server/connectivity/Tethering;->wifiTethered:Z

    if-nez v10, :cond_8

    iget-boolean v10, p0, Lcom/android/server/connectivity/Tethering;->bluetoothTethered:Z
...
.method public setUsbTethering(Z)I
    ...
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering;->mBootMode:Ljava/lang/String;
    ...
    const-string v5, "setting functions ("
