...
.method private cleanupUpstream()V
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering;->access$2500(Lcom/android/server/connectivity/Tethering;)I
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM$TetheredState;->modifyReverseNat(ZLjava/lang/String;)V
...
.method private modifyReverseNat(ZLjava/lang/String;)V
    .locals 9
    .parameter "isAdd"
    .parameter "upstreamIfaceName"

    .prologue
    const/4 v5, 0x0

    .local v5, upStreamIfIpAddr:Ljava/lang/String;
    :try_start_0
    ...
    .local v2, interfaceAddresses:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InterfaceAddress;>;"
    ...
    .local v3, item:Ljava/net/InterfaceAddress;
    ...
    .end local v2           #interfaceAddresses:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InterfaceAddress;>;"
    .end local v3           #item:Ljava/net/InterfaceAddress;
    :cond_0
    if-eqz v5, :cond_3
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mNMService:Landroid/os/INetworkManagementService;
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$2200(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;

    move-result-object v6

    const-string v7, "192.168.42.2"

    invoke-interface {v6, v5, v7}, Landroid/os/INetworkManagementService;->enableReverseNat(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v6, v5, v7}, Landroid/os/INetworkManagementService;->disableReverseNat(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v8, " Reverse Nat fail, get Exception="
    ...
    const-string v8, " Reverse Nat fail, ifname="
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v5, v9}, Lcom/android/server/connectivity/Tethering;->access$700(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v5, v11}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1100(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    #getter for: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mInitialState:Lcom/android/internal/util/State;
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1600(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;

    move-result-object v6

    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$2600(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1400(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;
    ...
    invoke-static {v7, v8}, Lcom/android/server/connectivity/Tethering;->access$2800(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)[Landroid/net/LinkAddress;

    move-result-object v7

    iput-object v7, v5, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mLinkAddrs:[Landroid/net/LinkAddress;
    ...
    iget-object v8, v8, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mLinkAddrs:[Landroid/net/LinkAddress;

    invoke-interface {v5, v7, v3, v8}, Landroid/os/INetworkManagementService;->enableNatBySubnet(Ljava/lang/String;Ljava/lang/String;[Landroid/net/LinkAddress;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-direct {p0, v6, v3}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM$TetheredState;->modifyReverseNat(ZLjava/lang/String;)V
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v5, v7}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1100(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    #getter for: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mInitialState:Lcom/android/internal/util/State;
    invoke-static {v7}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1600(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;

    move-result-object v7

    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v7}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$2900(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
