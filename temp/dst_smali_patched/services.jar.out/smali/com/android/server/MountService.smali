...
.field mDpm:Lcom/motorola/motepm/MotDevicePolicyManager;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, Lcom/android/server/MountService;->mShutDownCode:I
...
.method public getMountedObbPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, "Unknown error, maybe timeout?"
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v12}, Lcom/android/server/MountService;->orderedBroadcastIntentInNewThread(Landroid/content/Intent;)V
...
.method public shutdown(Landroid/os/storage/IMountShutdownObserver;)V
    ...
    iget-object v9, p0, Lcom/android/server/MountService;->mVolumeMap:Ljava/util/HashMap;
    ...
    invoke-direct {v8, p0, v3, p1}, Lcom/android/server/MountService$ShutdownCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Landroid/os/storage/IMountShutdownObserver;)V
    ...
    :try_start_4
    invoke-virtual {p0, v3, p1, v9}, Lcom/android/server/MountService;->shutdownComplete(Ljava/lang/String;Landroid/os/storage/IMountShutdownObserver;I)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
...
.method declared-synchronized shutdownComplete(Ljava/lang/String;Landroid/os/storage/IMountShutdownObserver;I)V
    .locals 3
    .parameter "path"
    .parameter "observer"
    .parameter "ret"
    ...
    :try_start_0
    iget v0, p0, Lcom/android/server/MountService;->mShutDownCode:I

    or-int/2addr v0, p3

    iput v0, p0, Lcom/android/server/MountService;->mShutDownCode:I

    iget v0, p0, Lcom/android/server/MountService;->mShutDownCount:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/android/server/MountService;->mShutDownCount:I
    ...
    const-string v2, "Shutdown complete for "
    ...
    invoke-interface {p2, v0}, Landroid/os/storage/IMountShutdownObserver;->onShutDownComplete(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
