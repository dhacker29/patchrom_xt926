...
.field private final mImeEnableddOnBoot:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    invoke-direct {v5, v10, v10, v8}, Lcom/android/internal/view/InputBindResult;-><init>(Lcom/android/internal/view/IInputMethodSession;Ljava/lang/String;I)V
    ...
    invoke-direct {v5, v8}, Landroid/util/LruCache;-><init>(I)V

    iput-object v5, p0, Lcom/android/server/InputMethodManagerService;->mSecureSuggestionSpans:Landroid/util/LruCache;

    new-instance v5, Lcom/android/server/InputMethodManagerService$1;

    invoke-direct {v5, p0}, Lcom/android/server/InputMethodManagerService$1;-><init>(Lcom/android/server/InputMethodManagerService;)V

    iput-object v5, p0, Lcom/android/server/InputMethodManagerService;->mVisibleConnection:Landroid/content/ServiceConnection;
    ...
    iput-boolean v6, p0, Lcom/android/server/InputMethodManagerService;->mScreenOn:Z

    iput v7, p0, Lcom/android/server/InputMethodManagerService;->mBackDisposition:I
    ...
    new-instance v8, Lcom/android/server/InputMethodManagerService$2;

    invoke-direct {v8, p0}, Lcom/android/server/InputMethodManagerService$2;-><init>(Lcom/android/server/InputMethodManagerService;)V

    invoke-direct {v5, p1, v8}, Lcom/android/internal/os/HandlerCaller;-><init>(Landroid/content/Context;Lcom/android/internal/os/HandlerCaller$Callback;)V
    ...
    new-instance v5, Lcom/android/server/InputMethodManagerService$HardKeyboardListener;

    invoke-direct {v5, p0, v10}, Lcom/android/server/InputMethodManagerService$HardKeyboardListener;-><init>(Lcom/android/server/InputMethodManagerService;Lcom/android/server/InputMethodManagerService$1;)V

    iput-object v5, p0, Lcom/android/server/InputMethodManagerService;->mHardKeyboardListener:Lcom/android/server/InputMethodManagerService$HardKeyboardListener;

    new-instance v5, Landroid/app/Notification;

    invoke-direct {v5}, Landroid/app/Notification;-><init>()V

    iput-object v5, p0, Lcom/android/server/InputMethodManagerService;->mImeSwitcherNotification:Landroid/app/Notification;

    iget-object v5, p0, Lcom/android/server/InputMethodManagerService;->mImeSwitcherNotification:Landroid/app/Notification;
    ...
    const-string v9, "android.system.imeswitcher"

    aput-object v9, v8, v7

    iput-object v8, v5, Landroid/app/Notification;->kind:[Ljava/lang/String;

    new-instance v3, Landroid/content/Intent;

    const-string v5, "android.settings.SHOW_INPUT_METHOD_PICKER"
    ...
    iput-object v5, p0, Lcom/android/server/InputMethodManagerService;->mImeSwitchPendingIntent:Landroid/app/PendingIntent;

    iput-boolean v7, p0, Lcom/android/server/InputMethodManagerService;->mShowOngoingImeSwitcherForPhones:Z
    ...
    :try_start_0
    new-instance v5, Lcom/android/server/InputMethodManagerService$InputMethodFileManager;

    iget-object v9, p0, Lcom/android/server/InputMethodManagerService;->mMethodMap:Ljava/util/HashMap;

    invoke-direct {v5, v9}, Lcom/android/server/InputMethodManagerService$InputMethodFileManager;-><init>(Ljava/util/HashMap;)V

    iput-object v5, p0, Lcom/android/server/InputMethodManagerService;->mFileManager:Lcom/android/server/InputMethodManagerService$InputMethodFileManager;
    ...
    invoke-direct {v5, p1, p0}, Lcom/android/server/InputMethodManagerService$InputMethodAndSubtypeListManager;-><init>(Landroid/content/Context;Lcom/android/server/InputMethodManagerService;)V
    ...
    invoke-virtual {v5, v8, v10, v6}, Lcom/android/server/InputMethodManagerService$MyPackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    new-instance v8, Lcom/android/server/InputMethodManagerService$ScreenOnOffReceiver;

    invoke-direct {v8, p0}, Lcom/android/server/InputMethodManagerService$ScreenOnOffReceiver;-><init>(Lcom/android/server/InputMethodManagerService;)V
    ...
    invoke-direct {v5, v8, v9, v10, v11}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;-><init>(Landroid/content/res/Resources;Landroid/content/ContentResolver;Ljava/util/HashMap;Ljava/util/ArrayList;)V
    ...
    :goto_0
    iput-boolean v5, p0, Lcom/android/server/InputMethodManagerService;->mImeSelectedOnBoot:Z
    ...
    invoke-static {v5}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->access$900(Lcom/android/server/InputMethodManagerService$InputMethodSettings;)Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v6, p0, Lcom/android/server/InputMethodManagerService;->mImeEnableddOnBoot:Z
    ...
    const-string v6, "No IME selected. Choose the most applicable IME."
    ...
    .end local v4           #screenOnOffFilt:Landroid/content/IntentFilter;
    :catchall_0
    move-exception v5
    ...
    .restart local v4       #screenOnOffFilt:Landroid/content/IntentFilter;
    :cond_1
    move v5, v7
...
.method buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;)V
    ...
    .local v10, disabledSysImes:Ljava/lang/String;
    if-nez v10, :cond_0
    ...
    const-string v23, "android.view.InputMethod"
    ...
    #calls: Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getEnabledInputMethodsStr()Ljava/lang/String;
    invoke-static/range {v22 .. v22}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->access$900(Lcom/android/server/InputMethodManagerService$InputMethodSettings;)Ljava/lang/String;

    move-result-object v12

    .local v12, enabledInputMethodsStr:Ljava/lang/String;
    const/16 v22, 0x0
    ...
    .local v16, needAdd:Ljava/lang/Boolean;
    move-object/from16 v0, p0
    ...
    const-string v22, "android.permission.BIND_INPUT_METHOD"
    ...
    const-string v24, "Skipping input method "
    ...
    const-string v24, ": it does not require the permission "

    invoke-virtual/range {v23 .. v24}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v23

    const-string v24, "android.permission.BIND_INPUT_METHOD"
    ...
    .end local v5           #additionalSubtypes:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .end local v7           #compName:Landroid/content/ComponentName;
    .end local v10           #disabledSysImes:Ljava/lang/String;
    .end local v12           #enabledInputMethodsStr:Ljava/lang/String;
    .end local v13           #haveHardKeyboard:Z
    .end local v14           #i:I
    .end local v16           #needAdd:Ljava/lang/Boolean;
    .end local v19           #ri:Landroid/content/pm/ResolveInfo;
    .end local v20           #services:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .restart local v5       #additionalSubtypes:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .restart local v7       #compName:Landroid/content/ComponentName;
    .restart local v10       #disabledSysImes:Ljava/lang/String;
    .restart local v12       #enabledInputMethodsStr:Ljava/lang/String;
    .restart local v13       #haveHardKeyboard:Z
    .restart local v14       #i:I
    .restart local v16       #needAdd:Ljava/lang/Boolean;
    .restart local v19       #ri:Landroid/content/pm/ResolveInfo;
    .restart local v20       #services:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    const-string v22, "com.google.android.googlequicksearchbox/com.google.android.voicesearch.ime.VoiceInputMethodService"
    ...
    .local v3, ICSVoiceId:Ljava/lang/String;
    ...
    const-string v22, "com.google.android.voicesearch/.ime.VoiceInputMethodService"
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->access$1100(Lcom/android/server/InputMethodManagerService$InputMethodSettings;)Ljava/util/List;

    move-result-object v24

    const-string v25, "com.google.android.voicesearch/.ime.VoiceInputMethodService"

    invoke-virtual/range {v22 .. v25}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->buildAndPutEnabledInputMethodsStrRemovingIdLocked(Ljava/lang/StringBuilder;Ljava/util/List;Ljava/lang/String;)Z

    .end local v3           #ICSVoiceId:Ljava/lang/String;
    :cond_4
    :goto_3
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/InputMethodManagerService;->isValidSystemDefaultIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z

    move-result v22

    if-nez v22, :cond_5

    invoke-static/range {v17 .. v17}, Lcom/android/server/InputMethodManagerService;->isSystemImeThatHasEnglishSubtype(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    iget-boolean v0, v0, Lcom/android/server/InputMethodManagerService;->mImeEnableddOnBoot:Z
    ...
    const-string v24, "Unable to load input method "
    ...
    :cond_8
    :try_start_1
    const-string v22, "com.android.inputmethod.latin/.LatinIME"
    ...
    const-string v4, "com.motorola.inputmethod.latinime/.LatinIME"

    .local v4, MotoIMEId:Ljava/lang/String;
    invoke-static {v12}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    const-string v22, "com.motorola.inputmethod.latinime/.LatinIME"
    ...
    const-string v25, "com.motorola.inputmethod.latinime/.LatinIME"
    ...
    .end local v4           #MotoIMEId:Ljava/lang/String;
    ...
    const-string v23, "Default IME is uninstalled. Choose new default IME."
...
.method setInputMethodEnabledLocked(Ljava/lang/String;Z)Z
    ...
    #calls: Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getEnabledInputMethodsAndSubtypeListLocked()Ljava/util/List;
    invoke-static {v6}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->access$1100(Lcom/android/server/InputMethodManagerService$InputMethodSettings;)Ljava/util/List;
