...
.field private static final ICON_NETWORKS_AVAILABLE:I = 0x108050e
...
.field private static final clientMacInfoPattern:Ljava/util/regex/Pattern;
...
.field private mApEntitlement:Lcom/motorola/android/server/ApEntitlement;
...
.field private mWifiRegDomService:Landroid/net/wifi/WifiRegDomService;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v3, Landroid/net/wifi/WifiRegDomService;

    iget-object v6, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;

    invoke-direct {v3, v6}, Landroid/net/wifi/WifiRegDomService;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/server/WifiService;->mWifiRegDomService:Landroid/net/wifi/WifiRegDomService;
    ...
    new-instance v3, Lcom/motorola/android/server/ApEntitlement;

    iget-object v4, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/motorola/android/server/ApEntitlement;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/server/WifiService;->mApEntitlement:Lcom/motorola/android/server/ApEntitlement;
    ...
    iget-object v3, p0, Lcom/android/server/WifiService;->mWifiRegDomService:Landroid/net/wifi/WifiRegDomService;

    invoke-static {p1}, Landroid/net/wifi/WifiRegDomService;->startThisService(Landroid/content/Context;)V
...
.method public disassociateSta()V
    ...
    invoke-interface {v2, v3}, Landroid/os/INetworkManagementService;->disassociateSta(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v4, "disassociateSta"
...
.method public getRange()Ljava/lang/String;
    ...
    const-string v6, "Dual band mode not supported. Only 2.4 GHz channels are available to be used"
    ...
    .local v3, nwService:Landroid/os/INetworkManagementService;
    sget-object v5, Lcom/android/server/WifiService;->mSoftapIface:Ljava/lang/String;

    invoke-interface {v3, v5}, Landroid/os/INetworkManagementService;->getRange(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v7, "Channel List in Wifi Service"
    ...
    .end local v0           #b:Landroid/os/IBinder;
    .end local v3           #nwService:Landroid/os/INetworkManagementService;
    :catch_0
    move-exception v2
    ...
    const-string v6, "Exception in getRange"
...
.method public setMaxSta(I)V
    ...
    invoke-interface {v2, p1, v3}, Landroid/os/INetworkManagementService;->setMaxSta(ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    iget-object v0, p0, Lcom/android/server/WifiService;->mApEntitlement:Lcom/motorola/android/server/ApEntitlement;

    invoke-virtual {v0, p1}, Lcom/motorola/android/server/ApEntitlement;->CheckEntitlement(Landroid/net/wifi/WifiConfiguration;)Z
...
.method public declared-synchronized setWifiEnabled(Z)Z
    ...
    invoke-virtual {v3, v4}, Landroid/net/wifi/WifiStateMachine;->setWifiEnabledAutonomous(Z)Z
    ...
    const-string v5, "setWifiEnabled enable="
    ...
    const-string v5, ", persist=true, pid="
...
.method public setWifiTxPower(I)Z
    ...
    invoke-virtual {v3, p1}, Landroid/net/wifi/WifiStateMachine;->setWifiTxPower(I)Z
    ...
    .local v2, nwService:Landroid/os/INetworkManagementService;
    invoke-interface {v2, p1}, Landroid/os/INetworkManagementService;->setWifiTxPower(I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "Exception is setWifiTxPower"
...
.method public updateSoftApDefaultFreq()V
    ...
    invoke-virtual {v0}, Landroid/net/wifi/WifiStateMachine;->updateSoftApDefaultFreq()V
