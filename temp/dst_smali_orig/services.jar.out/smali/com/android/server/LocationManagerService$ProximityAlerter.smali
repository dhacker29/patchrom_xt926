...
.method protected start(Landroid/location/GeoFenceParams;)Z
    ...
    invoke-static {v0}, Lcom/android/server/LocationManagerService;->access$1800(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$Receiver;
    ...
    invoke-static {v0, v1}, Lcom/android/server/LocationManagerService;->access$1802(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$Receiver;)Lcom/android/server/LocationManagerService$Receiver;
    ...
    #getter for: Lcom/android/server/LocationManagerService;->mProximityReceiver:Lcom/android/server/LocationManagerService$Receiver;
    invoke-static {v6}, Lcom/android/server/LocationManagerService;->access$1800(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$Receiver;
    ...
    invoke-static/range {v0 .. v7}, Lcom/android/server/LocationManagerService;->access$2000(Lcom/android/server/LocationManagerService;Ljava/lang/String;JFZLcom/android/server/LocationManagerService$Receiver;Landroid/location/Criteria;)V
...
.method protected stop(Landroid/app/PendingIntent;)Z
    ...
    invoke-static {v1}, Lcom/android/server/LocationManagerService;->access$2100(Lcom/android/server/LocationManagerService;)Ljava/util/HashSet;
    ...
    #getter for: Lcom/android/server/LocationManagerService;->mProximityReceiver:Lcom/android/server/LocationManagerService$Receiver;
    invoke-static {v2}, Lcom/android/server/LocationManagerService;->access$1800(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$Receiver;
    ...
    #setter for: Lcom/android/server/LocationManagerService;->mProximityReceiver:Lcom/android/server/LocationManagerService$Receiver;
    invoke-static {v1, v3}, Lcom/android/server/LocationManagerService;->access$1802(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$Receiver;)Lcom/android/server/LocationManagerService$Receiver;
