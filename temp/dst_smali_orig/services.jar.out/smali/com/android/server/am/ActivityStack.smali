...
#the value of this static final field might be set in the static constructor
.field static final LAUNCH_TICK:I = 0x0
...
.method static constructor <clinit>()V
    ...
    const-string v0, "debug.ams.launch_tick"

    const/16 v1, 0x1f4

    invoke-static {v0, v1}, Lcom/android/server/am/ActivityStack;->getIntPropWithoutException(Ljava/lang/String;I)I

    move-result v0

    sput v0, Lcom/android/server/am/ActivityStack;->LAUNCH_TICK:I
    ...
    sput v0, Lcom/android/server/am/ActivityStack;->MY_PID:I
...
.method private final notifyEventLog(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    .parameter "tag"
    .parameter "token"
    .parameter "taskId"
...
.method private final relaunchActivityLocked(Lcom/android/server/am/ActivityRecord;IZ)Z
    ...
    .local v9, results:Ljava/util/List;,"Ljava/util/List<Landroid/app/ResultInfo;>;"
    const/4 v8, 0x0

    .local v8, newIntents:Ljava/util/List;,"Ljava/util/List<Landroid/content/Intent;>;"
    if-eqz p3, :cond_0

    iget-object v9, p1, Lcom/android/server/am/ActivityRecord;->results:Ljava/util/ArrayList;

    iget-object v8, p1, Lcom/android/server/am/ActivityRecord;->newIntents:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/am/ActivityStack;->notifyEventLog(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private final startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    ...
    const-string v5, "Attempt to start activity before WindowManagerService started!"
...
.method private final startPausingLocked(ZZ)V
    ...
    const-string v2, "Trying to pause when pause is already pending for "
    ...
    invoke-virtual {p0, v8}, Lcom/android/server/am/ActivityStack;->screenshotActivities(Lcom/android/server/am/ActivityRecord;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-virtual {v8, v0, v9}, Lcom/android/server/am/ActivityRecord;->updateThumbnail(Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V
    ...
    iget-object v3, v8, Lcom/android/server/am/ActivityRecord;->shortComponentName:Ljava/lang/String;
    ...
    invoke-interface {v0, v1, v2, p1, v3}, Landroid/app/IApplicationThread;->schedulePauseActivity(Landroid/os/IBinder;ZZI)V

    const-string v1, "am_pause_activity"
    ...
    iget-object v4, v8, Lcom/android/server/am/ActivityRecord;->shortComponentName:Ljava/lang/String;
    ...
    iput-wide v0, v8, Lcom/android/server/am/ActivityRecord;->pauseTime:J
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/am/ActivityStack;->notifyEventLog(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Landroid/os/ParcelFileDescriptor;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-interface {v1, p1, p2, v2, v0}, Landroid/content/pm/IPackageManager;->resolveIntent(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;
    ...
    const-string v2, "com.motorola.activity.AnimInLaunchDisabled"
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILjava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    :cond_8
    :goto_6
    sget-boolean v2, Lcom/android/server/am/ActivityStack;->DEBUG_KPI:Z
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    iput-boolean v4, v3, Lcom/android/server/am/ProcessRecord;->pendingActvtyStart:Z
    ...
    iput-boolean v3, v12, Lcom/android/server/am/ProcessRecord;->pendingActvtyStart:Z
