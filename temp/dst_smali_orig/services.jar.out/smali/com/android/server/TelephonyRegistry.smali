...
.field private mPreviousDataNotifications:Ljava/util/concurrent/ConcurrentHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/TelephonyRegistry;->mPreviousDataNotifications:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public notifyDataConnection(IZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/LinkCapabilities;IZ)V
    ...
    .local v16, toBeNotified:Z
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/TelephonyRegistry;->mPreviousDataNotifications:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string v4, "dataStateNotification is null"
    ...
    invoke-direct/range {v2 .. v10}, Lcom/android/server/TelephonyRegistry$DataStateNotification;-><init>(IZLjava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/LinkCapabilities;IZ)V
    ...
    const-string v5, "new DataStateNotification for type:"
    ...
    iget v3, v15, Lcom/android/server/TelephonyRegistry$Record;->events:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iget-object v3, v15, Lcom/android/server/TelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;
    ...
    const-string v4, "dataStateNotification not null"
    ...
    invoke-virtual/range {v2 .. v10}, Lcom/android/server/TelephonyRegistry$DataStateNotification;->checkAndUpdateValues(IZLjava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/LinkCapabilities;IZ)Z
