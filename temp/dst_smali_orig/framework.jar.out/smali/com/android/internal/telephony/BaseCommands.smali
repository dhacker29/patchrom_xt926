...
.field private mSendFirstRadioOn:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/BaseCommands;->mSendFirstRadioOn:Z
...
.method protected setRadioState(Lcom/android/internal/telephony/CommandsInterface$RadioState;)V
    ...
    const-string v4, "Notifying: radio available"
    ...
    const-string v4, "Notifying: radio not available"
    ...
    const-string v4, "Notifying: Radio On"
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/BaseCommands;->mSendFirstRadioOn:Z

    if-nez v2, :cond_3

    new-instance v0, Landroid/content/Intent;

    const-string v2, "com.motorola.android.intent.action.FIRST_RADIO_ON"
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/BaseCommands;->mSendFirstRadioOn:Z

    const-string v2, "RILB"

    const-string v4, " send FIRST_RADIO_ON intent"
    ...
    const-string v4, "Notifying: radio off or not available"
