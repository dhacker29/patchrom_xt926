...
# static fields
.field private static final AVAILABLE_NETWORKS_ENTRY_SIZE:I = 0x5
...
# instance fields
.field private final ENABLE_HACK_SMS_DEBUG:Z
...
.method public constructor <init>(Landroid/content/Context;IILjava/lang/Integer;)V
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/RIL;->mPendingLock:Ljava/lang/Object;
    ...
    iput-boolean v6, p0, Lcom/android/internal/telephony/RIL;->ENABLE_HACK_SMS_DEBUG:Z
...
.method static synthetic access$100(Lcom/android/internal/telephony/RIL;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/RIL;->mPendingLock:Ljava/lang/Object;
...
.method private acquireWakeLock()V
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/RIL;->mPendingLock:Ljava/lang/Object;
...
.method private constructCdmaSendSmsRilRequest(Lcom/android/internal/telephony/RILRequest;[B)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/internal/telephony/RIL;->constructCdmaSendSmsRilRequestPrivate(Lcom/android/internal/telephony/RILRequest;[BZ)V

    return-void
.end method

.method private constructCdmaSendSmsRilRequestPrivate(Lcom/android/internal/telephony/RILRequest;[BZ)V
    .locals 16
    .parameter "rr"
    .parameter "pdu"
    .parameter "enableReplyOption"
    ...
    iget-object v14, v0, Lcom/android/internal/telephony/RILRequest;->mp:Landroid/os/Parcel;
    ...
    invoke-virtual {v14, v15}, Landroid/os/Parcel;->writeByte(B)V
    ...
    .local v1, address_nbr_of_digits:I
    move-object/from16 v0, p1
    ...
    .local v13, subaddr_nbr_of_digits:I
    move-object/from16 v0, p1
    ...
    invoke-virtual {v7, v5, v14, v4}, Ljava/io/DataInputStream;->read([BII)I
    ...
    const-string v15, "sendSmsCdmaIms: bearerDataLength = "
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/RIL;->riljLog(Ljava/lang/String;)V

    .end local v1           #address_nbr_of_digits:I
    .end local v4           #bearerDataLength:I
    .end local v5           #buffer:[B
    .end local v6           #count:I
    .end local v9           #i:I
    .end local v13           #subaddr_nbr_of_digits:I
    :cond_2
    :goto_2
    return-void

    .restart local v1       #address_nbr_of_digits:I
    .restart local v4       #bearerDataLength:I
    .restart local v5       #buffer:[B
    .restart local v6       #count:I
    .restart local v9       #i:I
    .restart local v13       #subaddr_nbr_of_digits:I
    :cond_3
    invoke-static {v5}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decode([B)Lcom/android/internal/telephony/cdma/sms/BearerData;
    ...
    iput-boolean v14, v3, Lcom/android/internal/telephony/cdma/sms/BearerData;->userAckReq:Z

    const/4 v14, 0x0

    iput-boolean v14, v3, Lcom/android/internal/telephony/cdma/sms/BearerData;->deliveryAckReq:Z

    const/4 v14, 0x0

    iput-boolean v14, v3, Lcom/android/internal/telephony/cdma/sms/BearerData;->readAckReq:Z

    const/4 v14, 0x0

    iput-boolean v14, v3, Lcom/android/internal/telephony/cdma/sms/BearerData;->reportReq:Z
    ...
    :cond_4
    invoke-static {v11}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decode([B)Lcom/android/internal/telephony/cdma/sms/BearerData;

    move-result-object v10

    .local v10, newBearerData:Lcom/android/internal/telephony/cdma/sms/BearerData;
    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string v15, "sendSmsCdmaIms: oldBearerDAta="
    ...
    const-string v15, "; newBearerData="
    ...
    .end local v6           #count:I
    .end local v9           #i:I
    .end local v10           #newBearerData:Lcom/android/internal/telephony/cdma/sms/BearerData;
    .end local v11           #newBearerDataPdu:[B
    ...
    const-string v15, "sendSmsCdma: conversion from input stream to object failed: "
...
.method private hackSmsByFile(Ljava/io/File;)Landroid/telephony/SmsMessage;
    .locals 1
    .parameter "file"
...
.method static requestToString(I)Ljava/lang/String;
    ...
    :pswitch_22
    const-string v0, "SIM_EXCHANGE_APDU"
...
.method private responseOperatorInfos(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v4}, Lcom/android/internal/telephony/OperatorInfo;->setRat(Ljava/lang/String;)V
...
.method public sendImsCdmaSms([BIILandroid/os/Message;)V
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/RIL;->getLteOnCdmaMode()I
    ...
    invoke-direct {p0, v0, p1, v1}, Lcom/android/internal/telephony/RIL;->constructCdmaSendSmsRilRequestPrivate(Lcom/android/internal/telephony/RILRequest;[BZ)V
    ...
    :cond_0
    invoke-direct {p0, v0, p1, v3}, Lcom/android/internal/telephony/RIL;->constructCdmaSendSmsRilRequestPrivate(Lcom/android/internal/telephony/RILRequest;[BZ)V
