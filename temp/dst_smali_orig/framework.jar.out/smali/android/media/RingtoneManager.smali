...
.field private static final CHECKIN_TAG_RINGTONE_L1:Ljava/lang/String; = "MOT_RINGTONE_L1"
...
.method private static getRingtone(Landroid/content/Context;Landroid/net/Uri;I)Landroid/media/Ringtone;
    ...
    .local v0, actualDefaultUri:Landroid/net/Uri;
    if-nez v0, :cond_1
    ...
    .end local v0           #actualDefaultUri:Landroid/net/Uri;
    :cond_1
    :try_start_0
    ...
    invoke-direct {v3, p0, v6}, Landroid/media/Ringtone;-><init>(Landroid/content/Context;Z)V
...
.method public static setActualDefaultRingtoneUri(Landroid/content/Context;ILandroid/net/Uri;)V
    ...
    new-instance v4, Landroid/media/RingtoneManager$1;

    invoke-direct {v4, v0, v3, v2}, Landroid/media/RingtoneManager$1;-><init>(Landroid/content/Context;Landroid/net/Uri;I)V

    invoke-virtual {v4}, Landroid/media/RingtoneManager$1;->start()V
