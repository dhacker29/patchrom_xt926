...
.method private setScanAlarm(Z)V
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$10700(Landroid/net/wifi/WifiStateMachine;)Landroid/app/AlarmManager;
...
.method public enter()V
    ...
    const-string v1, "enabledBackgroundScan: 1 \n"
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$16300(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/MotWifiScan;

    move-result-object v0

    invoke-virtual {v0, v5}, Landroid/net/wifi/MotWifiScan;->enableBackgroundPnoScan(Z)Z
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$16404(Landroid/net/wifi/WifiStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$16400(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v5}, Landroid/net/wifi/WifiStateMachine;->access$16404(Landroid/net/wifi/WifiStateMachine;)I
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mSupplicantScanIntervalMs:J
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$6800(Landroid/net/wifi/WifiStateMachine;)J
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$9600(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mScanResultIsPending:Z
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$7500(Landroid/net/wifi/WifiStateMachine;)Z
    ...
    const-string v5, "enabledBackgroundScan: 2 \n"
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mMotWifiScan:Landroid/net/wifi/MotWifiScan;
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$16300(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/MotWifiScan;

    move-result-object v2

    invoke-virtual {v2, v3}, Landroid/net/wifi/MotWifiScan;->enableBackgroundPnoScan(Z)Z
    ...
    const-string v4, "enabledBackgroundScan: 3 \n"
