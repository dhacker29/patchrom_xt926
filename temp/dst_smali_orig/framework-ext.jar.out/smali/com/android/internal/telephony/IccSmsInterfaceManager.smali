...
.method public declared-synchronized disableCdmaBroadcastRange(II)Z
    ...
    :try_start_0
    const-string v5, "disableCdmaBroadcastRange"
    ...
    invoke-virtual {v1, v5, v6}, Landroid/content/Context;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mCdmaBroadcastRangeManager:Lcom/android/internal/telephony/IccSmsInterfaceManager$CdmaBroadcastRangeManager;

    invoke-virtual {v5, p1, p2, v0}, Lcom/android/internal/telephony/IccSmsInterfaceManager$CdmaBroadcastRangeManager;->disableRange(IILjava/lang/String;)Z
    ...
    const-string v6, "Removed cdma broadcast subscription for MID range "
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/IccSmsInterfaceManager$CdmaBroadcastRangeManager;->isEmpty()Z
    ...
    :cond_1
    invoke-direct {p0, v3}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->setCdmaBroadcastActivation(Z)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized disableCellBroadcastRange(II)Z
    ...
    const-string v5, "Failed to remove cell broadcast subscription for MID range "
    ...
    const-string v6, "Removed cell broadcast subscription for MID range "
...
.method public declared-synchronized enableCdmaBroadcastRange(II)Z
    ...
    :try_start_0
    const-string v5, "enableCdmaBroadcastRange"
    ...
    const-string v6, "Enabling cdma broadcast SMS"
    ...
    invoke-virtual {v5, p1, p2, v0}, Lcom/android/internal/telephony/IccSmsInterfaceManager$CdmaBroadcastRangeManager;->enableRange(IILjava/lang/String;)Z
    ...
    const-string v6, "Added cdma broadcast subscription for MID range "
...
.method public declared-synchronized enableCellBroadcastRange(II)Z
    ...
    const-string v5, "Failed to add cell broadcast subscription for MID range "
    ...
    const-string v6, "Added cell broadcast subscription for MID range "
...
.method public sendTextMore(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;IILjava/lang/String;)V
    ...
    iget-object v2, v10, Landroid/telephony/SmsMessage$SubmitPdu;->encodedScAddress:[B
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/internal/telephony/SMSDispatcher;->sendRawPduMore([B[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, v4, v9}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
